<!-- Replace entire resources/views/livewire/floor-detail.blade.php -->
<div wire:poll.3s="loadFloorData">
    <!-- Back Button -->
    <div class="container mt-4">
        <div class="mb-4">
            <button wire:click="goBack" class="btn btn-outline-primary">
        ...
        <div class="row mb-4">
            <div class="col-md-3">
                <div class="campus-section text-center">
                    <h3 class="total-color">{{ $floorStats['total'] }}</h3>
                    <h6 class="text-muted">Total Spots</h6>
                </div>
            </div>
            <div class="col-md-3">
                <div class="campus-section text-center">
                    <h3 class="available-color">{{ $floorStats['available'] }}</h3>
                    <h6 class="text-muted">Available</h6>
                </div>
            </div>
            <div class="col-md-3">
                <div class="campus-section text-center">
                    <h3 class="occupied-color">{{ $floorStats['occupied'] }}</h3>
                    <h6 class="text-muted">Occupied</h6>
                </div>
            </div>
            <div class="col-md-3">
                <div class="campus-section text-center">
                    <h3 style="color: #6f42c1;">{{ $floorStats['occupancy_rate'] }}%</h3>
